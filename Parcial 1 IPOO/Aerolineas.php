...
class Aerolineas{
    ...
    */
    public function incorporarVuelo($objUnVuelo){
        ...
        if ($completoAccion){ # En el caso que no haya cambiado mi variable bandera entonces
            array_push($coleccionVuelos,$objUnVuelo); # Pusheo objUnVuelo a coleccionVuelos
            $this->setColVuelosInst($coleccionVuelos); # Modifico con el metodo set la coleccion de vuelos
        }
    ...
    */
    ...
    # Metodo montoPromedioRecaudado 
    /*
    el método  montoPromedioRecaudado que retorna el importe promedio recaudado por la aerolínea con cada uno de sus vuelos.
    */
    public function montoPromedioRecaudado(){
        # Hacer el metodo si da tiempo o si lo pide mas adelante
    }
}
?>